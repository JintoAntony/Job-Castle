...
<span style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#2699d6; font-size:17px;">FAQ</span>
<table width="100%" cellspacing="5" cellpadding="5">
       <tr>
       <td>
       <div id="accordion">
  <h3>How do we post jobs on hotelierglobal.com?</h3>
  <div>

AnswerAnswer answeransweransweranswer answeransweranswer
answeranswer answeransweranswer
  </div>
  <h3>What is the period of an account?</h3>
  <div>
...
answeranswer answeransweranswer
  ...
  <h3>What is the validity of a Posted Job?</h3>
  <div>
...
answeranswer answeransweranswer
  ...
  <h3>Can we post a job for a future date?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>Can I search for a job that I have posted?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>How can I view responses for the job posted?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>Will I have a jobseeker applying for a job more than once?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>What is CV Search? How many resumes can I view or download?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>How can I contact the candidates listed in my search result?</h3>
  <div>
...
answeranswer answeransweranswer
   ...
   <h3>What is e-mail Notifications?</h3>
  <div>
