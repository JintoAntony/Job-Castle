...
if($applied==1)
{
echo 'You are successfully applied for this job...<br>';

echo '<a href="jobseeker_home.php"> Back to search page </a>';  
}


else if($applied==0)
{
echo 'You are already applied for this job...<br>';

echo '<a href="jobseeker__home.php"> Back to search page </a>';  
}

else if($applied==2)
{
echo 'Error occured,Not applied.<br>';
